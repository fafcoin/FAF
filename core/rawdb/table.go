...
func NewTable(db fafdb.Database, prefix string) fafdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator(prefix []byte, start []byte) fafdb.Iterator {
...
func (t *table) NewBatch() fafdb.Batch {
...
func (b *tableBatch) Replay(w fafdb.KeyValueWriter) error {
