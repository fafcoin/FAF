...
import (
	...
	"github.com/ethereum/go-ethereum/fafdb/leveldb"
...
func NewDatabase(db fafdb.KeyValueStore) fafdb.Database {
	return &nofreezedb{
		KeyValueStore: db,
	}
}
...
// storage.
func NewDatabaseWithFreezer(db fafdb.KeyValueStore, freezer string, namespace string) (fafdb.Database, error) {
...
func NewMemoryDatabase() fafdb.Database {
...
func NewMemoryDatabaseWithCap(size int) fafdb.Database {
	return NewDatabase(memorydb.NewWithCap(size))
}

// NewLevelDBDatabase creates a persistent key-value database without a freezer
// moving immutable chain segments into cold storage.
func NewLevelDBDatabase(file string, cache int, handles int, namespace string) (fafdb.Database, error) {
...
// freezer moving immutable chain segments into cold storage.
func NewLevelDBDatabaseWithFreezer(file string, cache int, handles int, freezer string, namespace string) (fafdb.Database, error) {
...
func InspectDatabase(db fafdb.Database) error {
