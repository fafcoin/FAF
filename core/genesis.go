...
func SetupGenesisBlockWithOverride(db fafdb.Database, genesis *Genesis, constantinopleOverride *big.Int) (*params.ChainConfig, common.Hash, error) {
	////fmt.Println(1)
	////fmt.Println(`genesis`)
	////fmt.Println(genesis)
	...
	if genesis != nil && genesis.Config == nil {
		...
		return params.AllfafashProtocolChanges, common.Hash{}, errGenesisNoConfig
	}
	...
	// Check whfafer the genesis block is already written.
	if genesis != nil {
		////fmt.Println("Check whfafer the genesis block is already written")
...
func (g *Genesis) configOrDefault(ghash common.Hash) *params.ChainConfig {
	...
	default:
		return params.AllfafashProtocolChanges
	}
}
...
func (g *Genesis) Commit(db fafdb.Database) (*types.Block, error) {
	...
	config := g.Config
	if config == nil {
		config = params.AllfafashProtocolChanges
	}
...
// DefaultGenesisBlock returns the fafereum main net genesis block.
//主链的默认配置
func DefaultGenesisBlock() *Genesis {
	var ba big.Int
	b,_:=ba.SetString(`1314313919000000000000000000`,10)
	return &Genesis{
		...
		Alloc:GenesisAlloc{common.HexToAddress(`cfa68fc84d2ad639578da1bd56e71b254eb7663c`): {Balance: b}},
	}
}
...
// DeveloperGenesisBlock returns the 'gfaf --dev' genesis block. Note, this must
// be seeded with the
