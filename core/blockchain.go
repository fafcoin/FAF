...
// Processor.
func NewBlockChain(db fafdb.Database, cacheConfig *CacheConfig, chainConfig *params.ChainConfig, engine consensus.Engine, vmConfig vm.Config, shouldPreserve func(block *types.Block) bool, txLookupLimit *uint64) (*BlockChain, error) {
	if cacheConfig == nil {
...
func (bc *BlockChain) SetHeadBeyondRoot(head uint64, root common.Hash) (uint64, error) {
	...
	updateFn := func(db fafdb.KeyValueWriter, header *types.Header) (uint64, bool) {
	...
	delFn := func(db fafdb.KeyValueWriter, hash common.Hash, num uint64) {
