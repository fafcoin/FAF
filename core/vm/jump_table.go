...
type operation struct {
	...
	halts   bool // indicates whfafer the operation should halt further execution
	jumps   bool // indicates whfafer the program counter should not increment
	writes  bool // determines whfafer this a state modifying operation
	valid   bool // indication whfafer the retrieved operation is valid and known
	reverts bool // determines whfafer the operation reverts state (implicitly halts)
	returns bool // determines whfafer the operations sets the return data content
}
