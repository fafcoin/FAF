...
type Config struct {
	...
	State     *state.StateDB
	GfafashFn func(n uint64) common.Hash
}
...
func setDefaults(cfg *Config) {
	...
	if cfg.GfafashFn == nil {
		cfg.GfafashFn = func(n uint64) common.Hash {
...
func Execute(code, input []byte, cfg *Config) ([]byte, *state.StateDB, error) {
	...
	if cfg.State == nil {
		cfg.State, _ = state.New(common.Hash{}, state.NewDatabase(fafdb.NewMemDatabase()))
	}
	var (
...
// Create executes the code using the EVM create mfafod
