...
type Tree struct {
	diskdb fafdb.KeyValueStore      // Persistent database to store the snapshot
...
func New(diskdb fafdb.KeyValueStore, triedb *trie.Database, cache int, root common.Hash, async bool, recovery bool) *Tree {
