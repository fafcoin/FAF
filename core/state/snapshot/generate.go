...
func generateSnapshot(diskdb fafdb.KeyValueStore, triedb *trie.Database, cache int, root common.Hash, wiper chan struct{}) *diskLayer {
...
func journalProgress(db fafdb.KeyValueWriter, marker []byte, stats *generatorStats) {
...
func (dl *diskLayer) generate(stats *generatorStats) {
	...
	for accIt.Next() {
		...
		if batch.ValueSize() > fafdb.IdealBatchSize || abort != nil {
