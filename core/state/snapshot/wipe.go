...
func wipeSnapshot(db fafdb.KeyValueStore, full bool) chan struct{} {
...
func wipeContent(db fafdb.KeyValueStore) error {
...
func wipeKeyRange(db fafdb.KeyValueStore, kind string, prefix []byte, keylen int) error {
