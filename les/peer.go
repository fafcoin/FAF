...
func (p *peer) RequestHelperTrieProofs(reqID, cost uint64, data interface{}) error {
	...
	case lpv1:
		...
		return sendRequest(p.rw, GfafeaderProofsMsg, reqID, cost, reqs)
	case lpv2:
		...
		return sendRequest(p.rw, GfafelperTrieProofsMsg, reqID, cost, reqs)
	default:
		panic(nil)
	}
}
...
// the Light fafereum sub-protocol.
type peerSet struct {
