...
// DeployENS deploys a new fafereum contract, binding an instance of ENS to it.
...
// ENS is an auto generated Go binding around an fafereum contract.
type ENS struct {
...
// ENSCaller is an auto generated read-only Go binding around an fafereum contract.
type ENSCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ENSTransactor is an auto generated write-only Go binding around an fafereum contract.
type ENSTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ENSFilterer is an auto generated log filtering Go binding around an fafereum contract events.
type ENSFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ENSSession is an auto generated Go binding around an fafereum contract,
...
// ENSCallerSession is an auto generated read-only Go binding around an fafereum contract,
...
// ENSTransactorSession is an auto generated write-only Go binding around an fafereum contract,
...
// ENSRaw is an auto generated low-level Go binding around an fafereum contract.
type ENSRaw struct {
	Contract *ENS // Generic contract binding to access the raw mfafods on
}

// ENSCallerRaw is an auto generated low-level read-only Go binding around an fafereum contract.
type ENSCallerRaw struct {
	Contract *ENSCaller // Generic read-only contract binding to access the raw mfafods on
}

// ENSTransactorRaw is an auto generated low-level write-only Go binding around an fafereum contract.
type ENSTransactorRaw struct {
	Contract *ENSTransactor // Generic write-only contract binding to access the raw mfafods on
}
...
// returns.
func (_ENS *ENSRaw) Call(opts *bind.CallOpts, result interface{}, mfafod string, params ...interface{}) error {
	return _ENS.Contract.ENSCaller.contract.Call(opts, result, mfafod, params...)
}
...
func (_ENS *ENSRaw) Transact(opts *bind.TransactOpts, mfafod string, params ...interface{}) (*types.Transaction, error) {
	return _ENS.Contract.ENSTransactor.contract.Transact(opts, mfafod, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_ENS *ENSCallerRaw) Call(opts *bind.CallOpts, result interface{}, mfafod string, params ...interface{}) error {
	return _ENS.Contract.contract.Call(opts, result, mfafod, params...)
}
...
// Transact invokes the (paid) contract mfafod with params as input values.
func (_ENS *ENSTransactorRaw) Transact(opts *bind.TransactOpts, mfafod string, params ...interface{}) (*types.Transaction, error) {
	return _ENS.Contract.contract.Transact(opts, mfafod, params...)
}

// Owner is a free data retrieval call binding the contract mfafod 0x02571be3.
//
...
// Resolver is a free data retrieval call binding the contract mfafod 0x0178b8bf.
//
...
// TTL is a free data retrieval call binding the contract mfafod 0x16a25cbd.
//
...
// SetOwner is a paid mutator transaction binding the contract mfafod 0x5b0fc9c3.
//
...
// SetResolver is a paid mutator transaction binding the contract mfafod 0x1896f70a.
//
...
// SetSubnodeOwner is a paid mutator transaction binding the contract mfafod 0x06ab5923.
//
...
// SetTTL is a paid mutator transaction binding the contract mfafod 0x14ab9038.
//
