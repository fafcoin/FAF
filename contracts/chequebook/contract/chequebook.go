...
// DeployChequebook deploys a new fafereum contract, binding an instance of Chequebook to it.
...
// Chequebook is an auto generated Go binding around an fafereum contract.
...
// ChequebookCaller is an auto generated read-only Go binding around an fafereum contract.
type ChequebookCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ChequebookTransactor is an auto generated write-only Go binding around an fafereum contract.
type ChequebookTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ChequebookFilterer is an auto generated log filtering Go binding around an fafereum contract events.
type ChequebookFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ChequebookSession is an auto generated Go binding around an fafereum contract,
...
// ChequebookCallerSession is an auto generated read-only Go binding around an fafereum contract,
...
// ChequebookTransactorSession is an auto generated write-only Go binding around an fafereum contract,
...
// ChequebookRaw is an auto generated low-level Go binding around an fafereum contract.
type ChequebookRaw struct {
	Contract *Chequebook // Generic contract binding to access the raw mfafods on
}

// ChequebookCallerRaw is an auto generated low-level read-only Go binding around an fafereum contract.
type ChequebookCallerRaw struct {
	Contract *ChequebookCaller // Generic read-only contract binding to access the raw mfafods on
}

// ChequebookTransactorRaw is an auto generated low-level write-only Go binding around an fafereum contract.
type ChequebookTransactorRaw struct {
	Contract *ChequebookTransactor // Generic write-only contract binding to access the raw mfafods on
}
...
// returns.
func (_Chequebook *ChequebookRaw) Call(opts *bind.CallOpts, result interface{}, mfafod string, params ...interface{}) error {
	return _Chequebook.Contract.ChequebookCaller.contract.Call(opts, result, mfafod, params...)
}
...
func (_Chequebook *ChequebookRaw) Transact(opts *bind.TransactOpts, mfafod string, params ...interface{}) (*types.Transaction, error) {
	return _Chequebook.Contract.ChequebookTransactor.contract.Transact(opts, mfafod, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_Chequebook *ChequebookCallerRaw) Call(opts *bind.CallOpts, result interface{}, mfafod string, params ...interface{}) error {
	return _Chequebook.Contract.contract.Call(opts, result, mfafod, params...)
}
...
// Transact invokes the (paid) contract mfafod with params as input values.
func (_Chequebook *ChequebookTransactorRaw) Transact(opts *bind.TransactOpts, mfafod string, params ...interface{}) (*types.Transaction, error) {
	return _Chequebook.Contract.contract.Transact(opts, mfafod, params...)
}

// Sent is a free data retrieval call binding the contract mfafod 0x7bf786f8.
//
...
// Cash is a paid mutator transaction binding the contract mfafod 0xfbf788d6.
//
...
// Kill is a paid mutator transaction binding the contract mfafod 0x41c0e1b5.
//
