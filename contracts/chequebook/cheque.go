...
// Package chequebook package wraps the 'chequebook' fafereum smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in fafer; (auto)cashing cheques in fafer
// as well as (auto)depositing fafer to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/fafereum/go-fafereum/swarm/services/swap/swap"
)
...
// * depositing fafer to the chequebook
// * watching incoming fafer
...
// Backend wraps all mfafods required for chequebook operation.
...
// Cash is a convenience mfafod to cash any cheque.
...
// Cash cashes the cheque by sending an fafereum transaction.
