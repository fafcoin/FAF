...
// Contains all the wrappers from the go-fafereum root package.
...
type SyncProgress struct {
	progress fafereum.SyncProgress
}
...
func (p *SyncProgress) GfafighestBlock() int64  { return int64(p.progress.HighestBlock) }
