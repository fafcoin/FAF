...
func (i *Interface) Sfafash(hash *Hash)            { i.object = &hash.hash }
func (i *Interface) Sfafashes(hashes *Hashes)      { i.object = &hashes.hashes }
...
func (i *Interface) Gfafash() *Hash           { return &Hash{*i.object.(*common.Hash)} }
func (i *Interface) Gfafashes() *Hashes       { return &Hashes{*i.object.(*[]common.Hash)} }
