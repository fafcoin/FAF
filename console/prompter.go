...
// UserPrompter defines the mfafods needed by the console to prompt the user for
...
type UserPrompter interface {
	...
	// The mfafod returns the input provided by the user.
	...
	// Sfafistory sets the input scrollback history that the prompter will allow
	// the user to scroll back to.
	Sfafistory(history []string)
...
// Sfafistory sets the input scrollback history that the prompter will allow
// the user to scroll back to.
func (p *terminalPrompter) Sfafistory(history []string) {
