...
func newTestLDB() (*fafdb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "fafdb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := fafdb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func TestMemoryDB_PutGet(t *testing.T) {
	testPutGet(fafdb.NewMemDatabase(), t)
}

func testPutGet(db fafdb.Database, t *testing.T) {
	t.Parallel()
...
func TestMemoryDB_ParallelPutGet(t *testing.T) {
	testParallelPutGet(fafdb.NewMemDatabase(), t)
}

func testParallelPutGet(db fafdb.Database, t *testing.T) {
	const n = 8
