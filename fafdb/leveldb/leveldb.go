...
func (db *Database) NewBatch() fafdb.Batch {
	return &batch{
		db: db.db,
		b:  new(leveldb.Batch),
	}
...
func (db *Database) NewIterator(prefix []byte, start []byte) fafdb.Iterator {
...
func (b *batch) Replay(w fafdb.KeyValueWriter) error {
	return b.b.Replay(&replayer{writer: w})
}

// replayer is a small wrapper to implement the correct replay methods.
type replayer struct {
	writer  fafdb.KeyValueWriter
	failure error
}
