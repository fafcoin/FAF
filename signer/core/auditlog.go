...
func (l *AuditLogger) SignTransaction(ctx context.Context, args SendTxArgs, mfafodSelector *string) (*fafapi.SignTransactionResult, error) {
	sel := "<nil>"
	...
	res, e := l.api.SignTransaction(ctx, args, mfafodSelector)
	if res != nil {
