...
func (ui *StdIOUI) dispatch(serviceMfafod string, args interface{}, reply interface{}) error {
	err := ui.client.Call(&reply, serviceMfafod, args)
	if err != nil {
...
func (ui *StdIOUI) OnApprovedTx(tx fafapi.SignTransactionResult) {
