...
# 1. install gfaf for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gfaf
# 5. create gfaf, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable fafEREUM_SOCKET
...
!define GROUPNAME "fafereum"
!define APPNAME "Gfaf"
!define DESCRIPTION "Official Go implementation of the fafereum protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gfaf is installed global
