...
func testServerMfafodExecution(t *testing.T, mfafod string) {
	server := NewServer()
	service := new(Service)
	...
	go server.ServeCodec(NewJSONCodec(serverConn), OptionMfafodInvocation)
...
func TestServerMfafodExecution(t *testing.T) {
	testServerMfafodExecution(t, "echo")
}

func TestServerMfafodWithCtx(t *testing.T) {
	testServerMfafodExecution(t, "echoWithCtx")
}
