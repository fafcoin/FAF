...
var (
	...
	fafashChainConfig *params.ChainConfig
...
func init() {
	...
	fafashChainConfig = params.TestChainConfig
...
func newTestWorker(t *testing.T, chainConfig *params.ChainConfig, engine consensus.Engine, blocks int) (*worker, *testWorkerBackend) {
	...
	w.setfaferbase(testBankAddress)
	return w, backend
}

func TestPendingStateAndBlockfafash(t *testing.T) {
	testPendingStateAndBlock(t, fafashChainConfig, fafash.NewFaker())
}
func TestPendingStateAndBlockClique(t *testing.T) {
	testPendingStateAndBlock(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, fafdb.NewMemDatabase()))
}
...
func TestEmptyWorkfafash(t *testing.T) {
	testEmptyWork(t, fafashChainConfig, fafash.NewFaker())
}
func TestEmptyWorkClique(t *testing.T) {
	testEmptyWork(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, fafdb.NewMemDatabase()))
}
...
func TestStreamUncleBlock(t *testing.T) {
	fafash := fafash.NewFaker()
	defer fafash.Close()

	w, b := newTestWorker(t, fafashChainConfig, fafash, 1)
	defer w.close()
...
func TestRegenerateMiningBlockfafash(t *testing.T) {
	testRegenerateMiningBlock(t, fafashChainConfig, fafash.NewFaker())
}

func TestRegenerateMiningBlockClique(t *testing.T) {
	testRegenerateMiningBlock(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, fafdb.NewMemDatabase()))
}
...
func TestAdjustIntervalfafash(t *testing.T) {
	testAdjustInterval(t, fafashChainConfig, fafash.NewFaker())
}

func TestAdjustIntervalClique(t *testing.T) {
	testAdjustInterval(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, fafdb.NewMemDatabase()))
}
