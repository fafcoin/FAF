...
// It offers only mfafods that operates on data that can be available to anyone without security risks.
...
// Syncing provides information when this nodes starts synchronising with the fafereum network and when it's finished.
...
type SyncingResult struct {
	...
	Status  fafereum.SyncProgress `json:"status"`
}
