...
// Whisper represents a dark communication interface through the fafereum
...
// New creates a Whisper client ready to communicate through the fafereum P2P network.
...
// param isP2P indicates whfafer the message is peer-to-peer (should not be forwarded).
