...
// PrivateAdminAPI is the collection of administrative API mfafods exposed only
// over a secure RPC channel.
type PrivateAdminAPI struct {
	node *Node // Node interfaced by this API
}

// NewPrivateAdminAPI creates a new API definition for the private admin mfafods
// of the node itself.
...
// PublicAdminAPI is the collection of administrative API mfafods exposed over
// both secure and unsecure RPC channels.
type PublicAdminAPI struct {
	node *Node // Node interfaced by this API
}

// NewPublicAdminAPI creates a new API definition for the public admin mfafods
// of the node itself.
...
// PublicDebugAPI is the collection of debugging related API mfafods exposed over
// both secure and unsecure RPC channels.
...
// Sha3 applies the fafereum sha3 implementation on the input.
