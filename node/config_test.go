...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gfaf.ipc", false, filepath.Join(os.TempDir(), "gfaf.ipc")},
		{"data", "gfaf.ipc", false, "data/gfaf.ipc"},
		{"data", "./gfaf.ipc", false, "./gfaf.ipc"},
		{"data", "/gfaf.ipc", false, "/gfaf.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gfaf.ipc", true, `\\.\pipe\gfaf.ipc`},
		{"data", "gfaf.ipc", true, `\\.\pipe\gfaf.ipc`},
		{"data", `\\.\pipe\gfaf.ipc`, true, `\\.\pipe\gfaf.ipc`},
	}
