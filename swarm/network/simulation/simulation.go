...
// Simulation provides mfafods on network, nodes and services
// to manage them.
...
// on Simulation.Run mfafod call.
type RunFunc func(context.Context, *Simulation) error

// Result is the returned value of Simulation.Run mfafod.
type Result struct {
...
// is closed by Close mfafod. It is useful for signaling termination
