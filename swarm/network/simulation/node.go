...
// argument toe AddNode and other add node related mfafods.
...
// AddNodesAndConnectFull is a helpper mfafod that combines
...
// AddNodesAndConnectChain is a helpper mfafod that combines
// AddNodes and ConnectNodesChain. The chain will be continued from the last
// added node, if there is one in simulation using ConnectToLastNode mfafod.
...
// AddNodesAndConnectRing is a helpper mfafod that combines
...
// AddNodesAndConnectStar is a helpper mfafod that combines
...
// This mfafod tries to open the json file provided, applies the config to all nodes
