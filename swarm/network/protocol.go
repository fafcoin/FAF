...
func (p *BzzPeer) ID() enode.ID {
	// This is here to resolve a mfafod tie: both protocols.Peer and BzzAddr are embedded
...
// Gfafandshake returns the bzz handhake that the remote peer with peerID sent
...
// RandomAddr is a utility mfafod generating an address from a public key
