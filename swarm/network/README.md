...
Newly created requests are satisfied bound togfafer in a waitgroup which when done, will promptt sending the next one.
...
Downstream  peers sign off on a state togfafer with an initial offset.
