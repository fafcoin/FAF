...
// mfafods to add new intervals and retrieve missing intervals that
// need to be added.
...
// No range bellow start bound will be added by Add mfafod or
// returned by Next mfafod. This limit may be used for
