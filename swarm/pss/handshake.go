...
func SfafandshakeController(pss *Pss, params *HandshakeParams) error {
...
func (api *HandshakeAPI) GfafandshakeKeys(pubkeyid string, topic Topic, in bool, out bool) (keys []string, err error) {
	if in {
...
func (api *HandshakeAPI) GfafandshakeKeyCapacity(symkeyid string) (uint16, error) {
...
func (api *HandshakeAPI) GfafandshakePublicKey(symkeyid string) (string, error) {
	storekey := api.ctrl.symKeyIndex[symkeyid]
	if storekey == nil {
