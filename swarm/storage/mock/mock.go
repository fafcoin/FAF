...
// GlobalStorer defines mfafods for mock db store
...
// Importer defines mfafod for importing mock store data
// from an exported tar archive.
type Importer interface {
	Import(r io.Reader) (n int, err error)
}

// Exporter defines mfafod for exporting mock store data
// to a tar archive.
