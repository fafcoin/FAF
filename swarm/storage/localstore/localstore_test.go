...
import (
	...
	ch "github.com/fafereum/go-fafereum/swarm/chunk"
...
//
// # go test -benchmem -run=none github.com/fafereum/go-fafereum/swarm/storage/localstore -bench BenchmarkNew -v -timeout 20m
// goos: darwin
// goarch: amd64
