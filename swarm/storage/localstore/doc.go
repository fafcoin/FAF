// Copyright 2019 The go-fafereum Authors
// This file is part of the go-fafereum library.
//
// The go-fafereum library is free software: you can redistribute it and/or modify
// it under the terms of the GNU Lesser General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version.
//
// The go-fafereum library is distributed in the hope that it will be useful,
...
The main type is DB which manages the storage by providing mfafods to
...
that provides adequate mfafod to perform the opperation and that type
...
Subscription mfafods are implemented for a specific purpose of
