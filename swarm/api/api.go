...
var (
	...
	apiGfafTTP300          = metrics.NewRegisteredCounter("api.get.http.300", nil)
...
it is the public interface of the FileStore which is included in the fafereum stack
*/
type API struct {
	feed      *feed.Handler
...
// ErrNotAFeedManifest is returned when the address provided returned somfafing other than a valid manifest
