...
var (
	...
	ErrMorfafanOneValue = errors.New("rlp: input contains more than one value")
...
//
// The DecodeRLP mfafod should read one value from the given
...
// and starts reading from r. This mfafod is meant to facilitate reuse
