...
func (s *spongeDb) NewBatch() fafdb.Batch                { return &spongeBatch{s} }
...
func (s *spongeDb) NewIterator(prefix []byte, start []byte) fafdb.Iterator { panic("implement me") }
...
func (b *spongeBatch) Replay(w fafdb.KeyValueWriter) error { return nil }
