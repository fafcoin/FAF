...
// test all variations.
func makeProvers(trie *Trie) []func(key []byte) *fafdb.MemDatabase {
	var provers []func(key []byte) *fafdb.MemDatabase

	// Create a direct trie based Merkle prover
	provers = append(provers, func(key []byte) *fafdb.MemDatabase {
		proof := fafdb.NewMemDatabase()
