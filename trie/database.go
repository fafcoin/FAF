...
type Database struct {
	diskdb fafdb.KeyValueStore // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb fafdb.KeyValueStore) *Database {
...
func NewDatabaseWithConfig(diskdb fafdb.KeyValueStore, config *Config) *Database {
...
func (db *Database) DiskDB() fafdb.KeyValueStore {
	return db.diskdb
}
...
func (db *Database) commit(hash common.Hash, batch fafdb.Batch, uncacher *cleaner, callback func(common.Hash)) error {
