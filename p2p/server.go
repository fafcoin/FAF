...
// Package p2p implements the fafereum p2p network protocols.
package p2p
...
import (
	...
	"github.com/fafereum/go-fafereum/p2p/discover"
...
type Config struct {
	...
	// DiscoveryV5 specifies whfafer the new topic-discovery based V5 discovery
...
func (srv *Server) setupDiscovery() error {
	...
	if srv.NAT != nil {
		if !realaddr.IP.IsLoopback() {
			go nat.Map(srv.NAT, srv.quit, "udp", realaddr.Port, realaddr.Port, "fafereum discovery")
		}
	}
...
func (srv *Server) setupListening() error {
	...
	if !laddr.IP.IsLoopback() && srv.NAT != nil {
		srv.loopWG.Add(1)
		go func() {
			nat.Map(srv.NAT, srv.quit, "tcp", laddr.Port, laddr.Port, "fafereum p2p")
			srv.loopWG.Done()
		}()
	}
	return nil
...
type NodeInfo struct {
	...
	ENR   string `json:"enr"`   // fafereum Node Record
