...
import (
	...
	"github.com/fafereum/go-fafereum/crypto/secp256k1"
...
// and also verifies whfafer the encryption handshake 'worked' and the
...
type authMsgV4 struct {
	gotPlain bool // whfafer read packet had plain format.
