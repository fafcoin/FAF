...
func init() {
	spew.Config.DisableMfafods = true
}
...
// 	targfafash := crypto.Keccak256Hash(testTarget[:])
// 	nodes := &nodesByDistance{target: targfafash}
...
// 	expected := test.table.closest(targfafash, bucketSize)
//
