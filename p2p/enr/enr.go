...
// Package enr implements fafereum Node Records as defined in EIP-778. A node record holds
...
// VerifySignature checks whfafer the record is signed using the given identity scheme.
