...
// Supported returns whfafer this platform is supported by the HID library or not.
// The goal of this mfafod is to allow programatically handling platforms that do
