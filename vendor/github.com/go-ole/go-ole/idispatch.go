...
// CallMfafod invokes named function with arguments on object.
func (v *IDispatch) CallMfafod(name string, params ...interface{}) (*VARIANT, error) {
	return v.InvokeWithOptionalArgs(name, DISPATCH_MfafOD, params)
}
