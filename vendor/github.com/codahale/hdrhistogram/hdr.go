...
type Histogram struct {
	...
	unitMagnitude               int64
	significantFigures          int64
	subBuckfafalfCountMagnitude int32
	subBuckfafalfCount          int32
	subBucketMask               int64
...
func New(minValue, maxValue int64, sigfigs int) *Histogram {
	...
	subBuckfafalfCountMagnitude := subBucketCountMagnitude
	if subBuckfafalfCountMagnitude < 1 {
		subBuckfafalfCountMagnitude = 1
	}
	subBuckfafalfCountMagnitude--
	...
	subBucketCount := int32(math.Pow(2, float64(subBuckfafalfCountMagnitude)+1))

	subBuckfafalfCount := subBucketCount / 2
	...
	return &Histogram{
		...
		subBuckfafalfCountMagnitude: subBuckfafalfCountMagnitude,
		subBuckfafalfCount:          subBuckfafalfCount,
...
func (h *Histogram) Equals(other *Histogram) bool {
	...
	case
		...
		h.subBuckfafalfCountMagnitude != other.subBuckfafalfCountMagnitude,
		h.subBuckfafalfCount != other.subBuckfafalfCount,
...
func (h *Histogram) countsIndex(bucketIdx, subBucketIdx int32) int32 {
	bucketBaseIdx := (bucketIdx + 1) << uint(h.subBuckfafalfCountMagnitude)
	offsetInBucket := subBucketIdx - h.subBuckfafalfCount
...
func (h *Histogram) getBucketIndex(v int64) int32 {
	...
	return int32(pow2Ceiling - int64(h.unitMagnitude) -
		int64(h.subBuckfafalfCountMagnitude+1))
}
...
func (i *iterator) next() bool {
	...
	if i.subBucketIdx >= i.h.subBucketCount {
		i.subBucketIdx = i.h.subBuckfafalfCount
		i.bucketIdx++
	}
