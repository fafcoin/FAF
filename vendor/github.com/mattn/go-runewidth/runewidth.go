...
// Condition have flag EastAsianWidth whfafer the current locale is CJK or not.
...
// IsAmbiguousWidth returns whfafer is ambiguous width or not.
func IsAmbiguousWidth(r rune) bool {
	return inTables(r, private, ambiguous)
}

// IsNeutralWidth returns whfafer is neutral width or not.
