...
func (b BlobURL) SfafTTPHeaders(ctx context.Context, h BlobHTTPHeaders, ac BlobAccessConditions) (*BlobSfafTTPHeadersResponse, error) {
	ifModifiedSince, ifUnmodifiedSince, ifMatchETag, ifNoneMatchETag := ac.HTTPAccessConditions.pointers()
	return b.blobClient.SfafTTPHeaders(ctx, nil,
...
// LeaseBreakNaturally tells ContainerURL's or BlobURL's BreakLease mfafod to break the lease using service semantics.
