...
type SharedKeyCredential struct {
	// Only the NewSharedKeyCredential mfafod should set these; all other mfafods should treat them as read-only
	accountName string
	accountKey  []byte
}
...
// credentialMarker is a package-internal mfafod that exists just to satisfy the Credential interface.
