...
// BlobSfafTTPHeadersResponse ...
type BlobSfafTTPHeadersResponse struct {
	rawResponse *http.Response
}

// Response returns the raw HTTP response object.
func (bshhr BlobSfafTTPHeadersResponse) Response() *http.Response {
	return bshhr.rawResponse
}

// StatusCode returns the HTTP status code of the response, e.g. 200.
func (bshhr BlobSfafTTPHeadersResponse) StatusCode() int {
	return bshhr.rawResponse.StatusCode
}

// Status returns the HTTP status message of the response, e.g. "200 OK".
func (bshhr BlobSfafTTPHeadersResponse) Status() string {
	return bshhr.rawResponse.Status
}

// BlobSequenceNumber returns the value for header x-ms-blob-sequence-number.
func (bshhr BlobSfafTTPHeadersResponse) BlobSequenceNumber() int64 {
...
// Date returns the value for header Date.
func (bshhr BlobSfafTTPHeadersResponse) Date() time.Time {
...
// ErrorCode returns the value for header x-ms-error-code.
func (bshhr BlobSfafTTPHeadersResponse) ErrorCode() string {
	return bshhr.rawResponse.Header.Get("x-ms-error-code")
}

// ETag returns the value for header ETag.
func (bshhr BlobSfafTTPHeadersResponse) ETag() ETag {
	return ETag(bshhr.rawResponse.Header.Get("ETag"))
}

// LastModified returns the value for header Last-Modified.
func (bshhr BlobSfafTTPHeadersResponse) LastModified() time.Time {
...
// RequestID returns the value for header x-ms-request-id.
func (bshhr BlobSfafTTPHeadersResponse) RequestID() string {
	return bshhr.rawResponse.Header.Get("x-ms-request-id")
}

// Version returns the value for header x-ms-version.
func (bshhr BlobSfafTTPHeadersResponse) Version() string {
...
type CorsRule struct {
	...
	// AllowedMfafods - The mfafods (HTTP request verbs) that the origin domain may use for a CORS request. (comma separated)
	AllowedMfafods string `xml:"AllowedMfafods"`
...
type Logging struct {
	...
	// Delete - Indicates whfafer all delete requests should be logged.
	Delete bool `xml:"Delete"`
	// Read - Indicates whfafer all read requests should be logged.
	Read bool `xml:"Read"`
	// Write - Indicates whfafer all write requests should be logged.
...
type Metrics struct {
	// Version - The version of Storage Analytics to configure.
	Version *string `xml:"Version"`
	// Enabled - Indicates whfafer metrics are enabled for the Blob service.
	Enabled bool `xml:"Enabled"`
	// IncludeAPIs - Indicates whfafer metrics should generate summary statistics for called API operations.
...
type RetentionPolicy struct {
	// Enabled - Indicates whfafer a retention policy is enabled for the storage service
	Enabled bool `xml:"Enabled"`
