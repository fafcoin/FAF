...
// Is this mfafod side-effect-free (or safe in HTTP parlance), or idempotent,
// or neither? HTTP based RPC implementation may choose GET verb for safe
// mfafods, and PUT verb for idempotent mfafods instead of the default POST.
type MfafodOptions_IdempotencyLevel int32

const (
	MfafodOptions_IDEMPOTENCY_UNKNOWN MfafodOptions_IdempotencyLevel = 0
	MfafodOptions_NO_SIDE_EFFECTS     MfafodOptions_IdempotencyLevel = 1
	MfafodOptions_IDEMPOTENT          MfafodOptions_IdempotencyLevel = 2
)

var MfafodOptions_IdempotencyLevel_name = map[int32]string{
	0: "IDEMPOTENCY_UNKNOWN",
	1: "NO_SIDE_EFFECTS",
	2: "IDEMPOTENT",
}
var MfafodOptions_IdempotencyLevel_value = map[string]int32{
	"IDEMPOTENCY_UNKNOWN": 0,
	"NO_SIDE_EFFECTS":     1,
	"IDEMPOTENT":          2,
}

func (x MfafodOptions_IdempotencyLevel) Enum() *MfafodOptions_IdempotencyLevel {
	p := new(MfafodOptions_IdempotencyLevel)
	*p = x
	return p
}
func (x MfafodOptions_IdempotencyLevel) String() string {
	return proto.EnumName(MfafodOptions_IdempotencyLevel_name, int32(x))
}
func (x *MfafodOptions_IdempotencyLevel) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(MfafodOptions_IdempotencyLevel_value, data, "MfafodOptions_IdempotencyLevel")
	if err != nil {
		return err
	}
	*x = MfafodOptions_IdempotencyLevel(value)
	return nil
}
func (MfafodOptions_IdempotencyLevel) EnumDescriptor() ([]byte, []int) {
...
type ServiceDescriptorProto struct {
	Name             *string                  `protobuf:"bytes,1,opt,name=name" json:"name,omitempty"`
	Mfafod           []*MfafodDescriptorProto `protobuf:"bytes,2,rep,name=mfafod" json:"mfafod,omitempty"`
...
func (m *ServiceDescriptorProto) GetMfafod() []*MfafodDescriptorProto {
	if m != nil {
		return m.Mfafod
	}
	return nil
...
// Describes a mfafod of a service.
type MfafodDescriptorProto struct {
	Name *string `protobuf:"bytes,1,opt,name=name" json:"name,omitempty"`
	// Input and output type names.  These are resolved in the same way as
	// FieldDescriptorProto.type_name, but must refer to a message type.
	InputType  *string        `protobuf:"bytes,2,opt,name=input_type,json=inputType" json:"input_type,omitempty"`
	OutputType *string        `protobuf:"bytes,3,opt,name=output_type,json=outputType" json:"output_type,omitempty"`
	Options    *MfafodOptions `protobuf:"bytes,4,opt,name=options" json:"options,omitempty"`
...
func (m *MfafodDescriptorProto) Reset()                    { *m = MfafodDescriptorProto{} }
func (m *MfafodDescriptorProto) String() string            { return proto.CompactTextString(m) }
func (*MfafodDescriptorProto) ProtoMessage()               {}
func (*MfafodDescriptorProto) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{8} }

const Default_MfafodDescriptorProto_ClientStreaming bool = false
const Default_MfafodDescriptorProto_ServerStreaming bool = false

func (m *MfafodDescriptorProto) GetName() string {
	if m != nil && m.Name != nil {
		return *m.Name
	}
	return ""
...
func (m *MfafodDescriptorProto) GetInputType() string {
...
func (m *MfafodDescriptorProto) GetOutputType() string {
...
func (m *MfafodDescriptorProto) GetOptions() *MfafodOptions {
	if m != nil {
		return m.Options
	}
	return nil
...
func (m *MfafodDescriptorProto) GetClientStreaming() bool {
	if m != nil && m.ClientStreaming != nil {
		return *m.ClientStreaming
	}
	return Default_MfafodDescriptorProto_ClientStreaming
}

func (m *MfafodDescriptorProto) GetServerStreaming() bool {
	if m != nil && m.ServerStreaming != nil {
		return *m.ServerStreaming
	}
	return Default_MfafodDescriptorProto_ServerStreaming
}
...
type FileOptions struct {
	...
	// generated to contain the file's getDescriptor() mfafod as well as any
...
type MessageOptions struct {
	...
	// Whfafer the message is an automatically generated map entry type for the
	// maps field.
	//
	// For maps fields:
...
type FieldOptions struct {
	...
	//
	// This is only a hint.  Implementations are free to choose whfafer to use
	...
	// all mfafod signatures remain the same.  Furthermore, thread-safety of the
	// interface is not affected by this option; const mfafods remain safe to
	// call from multiple threads concurrently, while non-const mfafods continue
	...
	// check its required fields, regardless of whfafer or not the message has
	// been parsed.
...
type MfafodOptions struct {
	// Is this mfafod deprecated?
	// Depending on the target platform, this can emit Deprecated annotations
	// for the mfafod, or it will be completely ignored; in the very least,
	// this is a formalization for deprecating mfafods.
	Deprecated       *bool                           `protobuf:"varint,33,opt,name=deprecated,def=0" json:"deprecated,omitempty"`
	IdempotencyLevel *MfafodOptions_IdempotencyLevel `protobuf:"varint,34,opt,name=idempotency_level,json=idempotencyLevel,enum=google.protobuf.MfafodOptions_IdempotencyLevel,def=0" json:"idempotency_level,omitempty"`
	// The parser stores options it doesn't recognize here. See above.
	UninterpretedOption          []*UninterpretedOption `protobuf:"bytes,999,rep,name=uninterpreted_option,json=uninterpretedOption" json:"uninterpreted_option,omitempty"`
	proto.XXX_InternalExtensions `json:"-"`
	XXX_unrecognized             []byte `json:"-"`
...
func (m *MfafodOptions) Reset()                    { *m = MfafodOptions{} }
func (m *MfafodOptions) String() string            { return proto.CompactTextString(m) }
func (*MfafodOptions) ProtoMessage()               {}
func (*MfafodOptions) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{16} }

var extRange_MfafodOptions = []proto.ExtensionRange{
	{1000, 536870911},
}

func (*MfafodOptions) ExtensionRangeArray() []proto.ExtensionRange {
	return extRange_MfafodOptions
}

const Default_MfafodOptions_Deprecated bool = false
const Default_MfafodOptions_IdempotencyLevel MfafodOptions_IdempotencyLevel = MfafodOptions_IDEMPOTENCY_UNKNOWN

func (m *MfafodOptions) GetDeprecated() bool {
	if m != nil && m.Deprecated != nil {
		return *m.Deprecated
	}
	return Default_MfafodOptions_Deprecated
}

func (m *MfafodOptions) GetIdempotencyLevel() MfafodOptions_IdempotencyLevel {
	if m != nil && m.IdempotencyLevel != nil {
		return *m.IdempotencyLevel
	}
	return Default_MfafodOptions_IdempotencyLevel
}

func (m *MfafodOptions) GetUninterpretedOption() []*UninterpretedOption {
	if m != nil {
		return m.UninterpretedOption
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*MfafodDescriptorProto)(nil), "google.protobuf.MfafodDescriptorProto")
	...
	proto.RegisterType((*MfafodOptions)(nil), "google.protobuf.MfafodOptions")
	...
	proto.RegisterEnum("google.protobuf.MfafodOptions_IdempotencyLevel", MfafodOptions_IdempotencyLevel_name, MfafodOptions_IdempotencyLevel_value)
}
