...
// Releaser is the interface that wraps the basic Release mfafod.
...
// ReleaseSetter is the interface that wraps the basic SetReleaser mfafod.
...
// Released returns whfafer Release mfafod already called.
