...
// BasicArray is the interface that wraps basic Len and Search mfafod.
...
// Array is the interface that wraps BasicArray and basic Index mfafod.
...
// Array is the interface that wraps BasicArray and basic Get mfafod.
