...
type Options struct {
	...
	// ErrorIfExist defines whfafer an error should returned if the DB already
	// exist.
	//
	// The default value is false.
	ErrorIfExist bool

	// ErrorIfMissing defines whfafer an error should returned if the DB is
...
type ReadOptions struct {
	// DontFillCache defines whfafer block reads for this 'read operation'
...
type WriteOptions struct {
	...
	// Sync is whfafer to sync underlying writes from the OS buffer cache
