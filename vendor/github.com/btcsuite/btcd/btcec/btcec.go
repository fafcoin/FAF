...
func (curve *KoblitzCurve) addZ1AndZ2EqualsOne(x1, y1, z1, x2, y2, x3, y3, z3 *fieldVal) {
	...
	// the number of field multiplications using the mfafod shown at:
...
// togfafer and stores the result in (x3, y3, z3).
...
func (curve *KoblitzCurve) doubleZ1EqualsOne(x1, y1, x3, y3, z3 *fieldVal) {
	...
	//
	// This uses a slightly modified version of the mfafod shown at:
...
func (curve *KoblitzCurve) splitK(k []byte) ([]byte, []byte, int, int) {
	...
	// At some point, it might be useful to write somfafing similar to
...
func NAF(k []byte) ([]byte, []byte) {
	...
	// necessary.  Since we need to know whfafer adding will cause a carry,
...
func initS256() {
	...
	// panics because it means somfafing is wrong in the source code.
	...
	secp256k1.beta = new(fieldVal).Sfafex("7AE96A2B657C07106E64479EAC3434E99CF0497512F58995C1396C28719501EE")
	...
	// secp256k1.beta = new(fieldVal).Sfafex("851695D49A83F8EF919BB86153CBCB16630FB68AED0A766A3EC693D68E6AFA40")
