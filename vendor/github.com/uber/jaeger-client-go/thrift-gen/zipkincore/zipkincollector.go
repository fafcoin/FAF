...
func (p *ZipkinCollectorClient) recvSubmitZipkinBatch() (value []*Response, err error) {
	...
	if mfafod != "submitZipkinBatch" {
		err = thrift.NewTApplicationException(thrift.WRONG_MfafOD_NAME, "submitZipkinBatch failed: wrong mfafod name")
		return
	}
	if p.SeqId != seqId {
...
func (p *ZipkinCollectorProcessor) Process(iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	x5 := thrift.NewTApplicationException(thrift.UNKNOWN_MfafOD, "Unknown function "+name)
