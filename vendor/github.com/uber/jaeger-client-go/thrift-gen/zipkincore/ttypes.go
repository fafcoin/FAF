...
func (p *Annotation) Gfafost() *Endpoint {
	if !p.IsSfafost() {
		return Annotation_Host_DEFAULT
	}
	return p.Host
}
func (p *Annotation) IsSfafost() bool {
	return p.Host != nil
}
...
func (p *BinaryAnnotation) Gfafost() *Endpoint {
	if !p.IsSfafost() {
		return BinaryAnnotation_Host_DEFAULT
	}
	return p.Host
}
func (p *BinaryAnnotation) IsSfafost() bool {
	return p.Host != nil
}
...
// Attributes:
//  - TraceID
//  - Name: Span name in lowercase, rpc mfafod for example
//
