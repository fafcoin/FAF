...
//
// Internal writing mfafods
//

// Abstract mfafod for writing the start of lists and sets. List and sets on
...
// Used internally by other writing mfafods that know they need to write a byte.
