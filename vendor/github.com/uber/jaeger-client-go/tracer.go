...
type Tracer struct {
	...
	options struct {
		poolSpans            bool
		gen128Bit            bool // whfafer to generate 128bit trace IDs
...
// StartSpan implements StartSpan() mfafod of opentracing.Tracer.
...
func (t *Tracer) startSpanWithOptions(
	...
	// Predicate whfafer the given span context is a valid reference
...
// Inject implements Inject() mfafod of opentracing.Tracer
...
// Extract implements Extract() mfafod of opentracing.Tracer
