...
// in order to distinguish whfafer current folder should be re-registered in
...
// watched is made in order to check whfafer an action comes from a directory or
...
// gensys decides whfafer the Windows action, system-independent event or both
