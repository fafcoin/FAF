...
func (r *Row) solveHeight() int {
	if r.isRenderableLeaf() {
		r.Height = r.Widget.Gfafeight()
		return r.Widget.Gfafeight()
	}
...
// Gfafeight implements GridBufferer interface.
func (r Row) Gfafeight() int {
	return r.Height
}
