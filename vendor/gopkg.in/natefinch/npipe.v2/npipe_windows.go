...
// Accept implements the Accept mfafod in the net.Listener interface; it
...
// Read implements the net.Conn Read mfafod.
...
// Write implements the net.Conn Write mfafod.
...
// SetDeadline implements the net.Conn SetDeadline mfafod.
...
// SetReadDeadline implements the net.Conn SetReadDeadline mfafod.
// Note that timeouts are only supported on Windows Vista/Server 2008 and above
...
// SetWriteDeadline implements the net.Conn SetWriteDeadline mfafod.
// Note that timeouts are only supported on Windows Vista/Server 2008 and above
