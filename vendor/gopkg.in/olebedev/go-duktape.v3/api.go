...
// See: http://duktape.org/api.html#duk_call_mfafod
func (d *Context) CallMfafod(nargs int) {
	C.duk_call_mfafod(d.duk_context, C.duk_idx_t(nargs))
}
...
func (d *Context) Gfafeapptr(index int) unsafe.Pointer {
...
// See: http://duktape.org/api.html#duk_pcall_mfafod
func (d *Context) PcallMfafod(nargs int) int {
	return int(C.duk_pcall_mfafod(d.duk_context, C.duk_idx_t(nargs)))
}
