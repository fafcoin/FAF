...
There is a mfafod to inject timers to the global scope:
```go
package main
...
Pull requests are welcome! Also, if you want to discuss somfafing send a pull request with proposal and changes.
