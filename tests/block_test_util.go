...
// Package tests implements execution of fafereum JSON tests.
package tests
...
/* See https://github.com/fafereum/tests/wiki/Blockchain-Tests-II

   Whfafer a block is valid or not is a bit subtle, it's defined by presence of
