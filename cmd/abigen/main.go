...
import (
	...
	"github.com/fafereum/go-fafereum/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the fafereum contract ABI json to bind, - for STDIN")
	binFlag = flag.String("bin", "", "Path to the fafereum contract bytecode (generate deploy mfafod)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the fafereum contract Solidity source to build and bind")
