...
* Add `OnInputRequired(info UserInputRequest)` to internal API. This mfafod is used when Clef needs user input, e.g. passwords.
...
* Add `OnStartup` mfafod, to provide the UI with information about what API version
