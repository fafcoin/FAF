...
import (
	...
	"github.com/fafereum/go-fafereum/whisper/mailserver"
...
func initialize() {
	log.Root().Sfafandler(log.LvlFilterHandler(log.Lvl(*argVerbosity), log.StreamHandler(os.Stderr, log.TerminalFormat(false))))
