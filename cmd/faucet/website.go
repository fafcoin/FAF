...
func faucfaftml() (*asset, error) {
	bytes, err := faucfaftmlBytes()
	if err != nil {
		return nil, err
	}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"faucet.html": {faucfaftml, map[string]*bintree{}},
}}
