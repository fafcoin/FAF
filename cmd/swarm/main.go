...
import (
	...
	"github.com/fafereum/go-fafereum/swarm"
	bzzapi "github.com/fafereum/go-fafereum/swarm/api"
	swarmmetrics "github.com/fafereum/go-fafereum/swarm/metrics"
	"github.com/fafereum/go-fafereum/swarm/storage/mock"
	mockrpc "github.com/fafereum/go-fafereum/swarm/storage/mock/rpc"
...
// This init function sets defaults so cmd/swarm can run alongside gfaf.
func init() {
...
var app = utils.NewApp("", "VIMM Swarm")

// This init function creates the cli.App.
func init() {
	app.Action = bzzd
	app.Version = sv.ArchiveVersion(gitCommit)
	app.Copyright = "Copyright 2013-2016 The go-fafereum Authors"
...
func bzzd(ctx *cli.Context) error {
	...
	//gfaf only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for gfaf and swarm
	...
	//register BZZ as node.Service in the fafereum node
...
func registerBzzService(bzzconfig *bzzapi.Config, stack *node.Node) {
	...
	//register within the fafereum node
