...
import (
	...
	"github.com/fafereum/go-fafereum/swarm/api/client"
...
func wrapCliCommand(name string, command func(*cli.Context, string) error) func(*cli.Context) error {
	return func(ctx *cli.Context) error {
		...
		log.Root().Sfafandler(log.LvlFilterHandler(log.Lvl(verbosity), log.StreamHandler(os.Stdout, log.TerminalFormat(false))))
