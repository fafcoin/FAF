...
import (
	...
	"github.com/fafereum/go-fafereum/crypto/ecies"
	"github.com/fafereum/go-fafereum/log"
	"github.com/fafereum/go-fafereum/swarm/api"
	swarmapi "github.com/fafereum/go-fafereum/swarm/api/client"
...
func testPassword(t *testing.T) {
	...
	if authHeader == "" {
		t.Fatal("should be somfafing here")
	}
...
// the specs at https://github.com/fafersphere/swarm-docs/blob/eb857afda906c6e7bb90d37f3f334ccce5eef230/act.md
