...
// mfafod triggerings. In the affected component's shouldComponentUpdate mfafod it can be checked
// whfafer the involved data was changed or not by checking the message structure.
//
